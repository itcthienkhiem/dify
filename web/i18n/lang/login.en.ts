const translation = {
  ...
  welcome: 'Welcome to ChatSpace, please log in to continue.',
  email: 'Email address',
  ...
  license: {
    tip: 'Before starting Chatspace Community Edition, read the GitHub',
    link: 'Open-source License',
  },
  join: 'Join',
  joinTipStart: 'Invite you join',
  joinTipEnd: 'team on Chatspace',
  invalid: 'The link has expired',
  explore: 'Explore Chatspace',
