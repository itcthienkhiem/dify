...
class ProviderQuotaExceededError(BaseHTTPException):
    ...
    description = "Your quota for Chatspace Hosted Model Provider has been exhausted. " \
...
class ProviderModelCurrentlyNotSupportError(BaseHTTPException):
    ...
    description = "Chatspace Hosted OpenAI trial currently not support the GPT-4 model."
    code = 400
